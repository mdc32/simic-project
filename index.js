...
textNode.prototype.write = function(isEnd) {
	...
	if (isEnd) {
		$("#mainDiv").delay(7000).fadeOut(3000);
	}
...
nodes[2] = new textNode(["%iThat one remaining, barely moving leaf the wind couldn't get to fall all winter long from a bare tree...", "You decide to take a walk to clear your head. As you pass a now-decrepit church, you feel a chill come over you. Do you ENTER or KEEP WALKING?", ""], [{inputs: ["enter"], id: 3}, {inputs: ["keep walking"], id: 4}]);
